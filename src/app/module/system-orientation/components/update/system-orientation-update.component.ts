...
import { systemOrientation } from '../../interface/system-orientation';
import { systemOrientationDataForm } from "../../interface/system-orientation-data-form";
import { NgbActiveModal } from "@ng-bootstrap/ng-bootstrap";
import Swal from 'sweetalert2';

@Component({
  selector: 'app-system-orientation-update',
  templateUrl: './system-orientation-update.component.html',
  styles: []
})

export class systemOrientationUpdateComponent extends systemOrientationDataForm implements OnInit {
  form: FormGroup;
  loading = true;
  register = false;
  @Input() modal = false;
