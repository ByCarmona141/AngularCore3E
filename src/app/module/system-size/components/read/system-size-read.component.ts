...
@Component({
  ...
  templateUrl: './system-size-read.component.html',
  styleUrls: []
})
export class systemSizeReadComponent implements OnInit {
  disabled = true;
  serveSource = 'systemSize';
  ...
  constructor(public auth: AuthService,
    ...
    this.privilegesService.getPrivileges('systemSize')
      .subscribe(data => {
        this.privilege = data;
      });
  }
  ...
  update(id: number): void {
    this.router.navigateByUrl('/systemSize/update/' + id);
  }
